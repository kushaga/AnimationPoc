...
public class AppBarLayout extends LinearLayout {
        ...
        public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
            if (child.getLayoutParams().height == -1) {
                ...
                if (appBar != null && ViewCompat.isLaidOut(appBar)) {
                    ...
                    int heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, -2147483648);
        ...
        public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
            ...
            if (behavior instanceof AppBarLayout.Behavior) {
                ...
                if (this.mOverlayTop != 0 && dependency instanceof AppBarLayout) {
                    ...
                    this.setTopAndBottomOffset(MathUtils.constrain(dependency.getHeight() - this.mOverlayTop + appBarOffset, collapsedMin, expandedMax));
                }
            }
    ...
    public static class Behavior extends ViewOffsetBehavior<AppBarLayout> {
        ...
        final int setAppBarTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int newOffset) {
            return this.setAppBarTopBottomOffset(coordinatorLayout, appBarLayout, newOffset, -2147483648, 2147483647);
        }
        ...
        protected static class SavedState extends BaseSavedState {
            ...
            public static final Creator<AppBarLayout.Behavior.SavedState> CREATOR = new Creator() {
