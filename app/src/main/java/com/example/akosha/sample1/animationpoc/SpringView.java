...
public class SpringView extends View {
    ...
    private void makePath() {
        ...
        /*path.reset();
        path.moveTo(x1, (float) (y1 * (2.3)));//begning of the next curve at this point
        path.quadTo(anchorX, (float) (anchorY * 2.3), x3, (float) (y3 * 2.3));//add a curve to (approaching_point , ending point)
        path.lineTo(x4, (float) (y4 * 2.5));//add a line from the last point to this point
        path.quadTo(anchorX, (float) (anchorY * 2.3), x2, (float) (y2 * 2.3));
        path.lineTo(x1, (float) (y1 * 2.5));*/
