...
class SmartTabStrip extends LinearLayout {
    ...
    private void makePath() {
        ...
        path.reset();
        path.moveTo(x1, y1);
        path.quadTo(anchorX, anchorY*4.7f, x3, y3*4.7f);
        path.lineTo(x4, y4);
        path.quadTo(anchorX, anchorY*4.7f, x2, y2*4.7f);
        path.lineTo(x1, y1);
    }
    ...
    public void animCreate() {
        ...
        ObjectAnimator oaX = ObjectAnimator.ofFloat(this, "scaleX", 0.2f, 1f);
        ObjectAnimator oaY = ObjectAnimator.ofFloat(this, "scaleY", 0.2f, 1f);
    ...
    private void drawIndicator(Canvas canvas, int left, int right, int height, float thickness,
        ...
        if (indicatorCornerRadius > 0f) {
            ...
            //canvas.drawRoundRect(indicatorRectF, indicatorCornerRadius,indicatorCornerRadius*2.5f, indicatorPaint);
            //canvas.drawCircle(indicatorRectF.centerX(), indicatorRectF.centerY() * (1.7f), indicatorCornerRadius * (2f), indicatorPaint);
            canvas.drawCircle(headPoint.getX(),headPoint.getY(), headPoint.getRadius() * (2f),indicatorPaint);
            canvas.drawCircle(headPoint.getX(),headPoint.getY(), headPoint.getRadius() * (2f),indicatorPaint);
            //canvas.drawCircle(footPoint.getX(), footPoint.getY(), headPoint.getRadius() * (2f), indicatorPaint);
        } else {
